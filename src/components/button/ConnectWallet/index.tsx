...
import { walletAtom } from "@/src/store/wallet";
              ...
              if (!connected) {
                return (
                  <button
                    ...
                    type="button"
                    className="w-full bg-gradient-to-tr from-pink-500 to-yellow-500 text-white shadow-lg p-2 rounded-lg"
                  >
                    Connect Wallet
                  </button>
                );
                ...
                <div className="flex gap-1.5 sm:gap-3">
                  ...
                  >
                    ...
                    <div className="flex gap-1 items-center sm:bg-default-300/70 sm:pl-2 rounded-[10px]">
                      <Icon
                        icon="entypo:wallet"
                        className="w-[24px] h-[24px] sm:w-[20px] sm:h-[20px] "
                        style={{ color: " #d7da44" }}
                      />
